...
{{- if .Values.postgresql.replicationPassword }}
    {{- .Values.postgresql.replicationPassword -}}
...
{{- if .Values.postgresql.replicationUser }}
    {{- .Values.postgresql.replicationUser -}}
{{- else -}}

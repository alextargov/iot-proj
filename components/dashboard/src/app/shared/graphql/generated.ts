...
export type DataModelInfoFragment = {
    __typename?: 'DataModel';
    id: string;
    name: string;
    description: string;
...
export type ListDataModelsQuery = {
    __typename?: 'Query';
    dataModels: Array<{
        __typename?: 'DataModel';
        id: string;
...
export type DeviceInfoFragment = {
    ...
    auth?: {
        __typename?: 'Auth';
        credentialForService?: string | null;
        credentialForDevice?:
            | {
                  __typename?: 'BasicCredentialData';
                  username: string;
...
export type WidgetInfoFragment = {
    __typename?: 'Widget';
    id: string;
    name: string;
    description?: string | null;
...
export type GetAllWidgetsQuery = {
    __typename?: 'Query';
    widgets: Array<{
        __typename?: 'Widget';
        id: string;
...
export class ListDataModelsGQL extends Apollo.Query<
    ListDataModelsQuery,
    ListDataModelsQueryVariables
> {
...
export class CreateDataModelGQL extends Apollo.Mutation<
...
export class DeleteDataModelGQL extends Apollo.Mutation<
...
export class GetAllWidgetsGQL extends Apollo.Query<
    GetAllWidgetsQuery,
...
export class CreateWidgetGQL extends Apollo.Mutation<
...
export class DeleteWidgetGQL extends Apollo.Mutation<

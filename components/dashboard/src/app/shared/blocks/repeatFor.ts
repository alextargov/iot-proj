...
export class RepeatForBlock extends CustomBlock {
  ...
  public defineBlock() {
    ...
    this.block.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown([["seconds",RepeatTypes.SECONDS.toString()], ["minutes",RepeatTypes.MINUTES.toString()], ["hours",RepeatTypes.HOURS.toString()], ["days",RepeatTypes.DAYS.toString()]]), "intervalType");
...
setInterval(async () => {
  ...
  public calculateInterval(intervalType: string, intervalValue: number): number {
    switch (intervalType) {
